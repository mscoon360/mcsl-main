  ...
  },
  {
    ...
    items: [
      ...
      { name: "Trial Balance", href: "/trial-balance", icon: Scale },
      {
        ...
        icon: FileText,
        subItems: [
          { name: "Overview", href: "/finance-reports" },
          { name: "General Ledger", href: "/reports/general-ledger" },
          { name: "Account Ledger", href: "/reports/account-ledger" },
          { name: "Journal Day Book", href: "/reports/journal-day-book" },
          ...
          { name: "VAT Report", href: "/reports/vat-report" },
        ],
      },
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <SidebarMenuButton asChild>
                            <NavLink
                              to={item.href!}
                              className={`flex items-center gap-2 md:gap-3 px-2 md:px-3 py-1.5 md:py-2 rounded-lg transition-colors text-sm font-medium ${
                                isActive(item.href!)
