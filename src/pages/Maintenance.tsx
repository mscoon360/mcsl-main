...
export default function Maintenance() {
  ...
  return <div className="space-y-6 p-6">
            ...
            <form onSubmit={handleAddMaintenance} className="space-y-4">
              <div className="space-y-2">
                ...
                <Select name="product_id" required>
                  ...
                  <SelectContent>
                    {products.filter(p => p.needs_servicing && (p.is_rental || p.is_rental_only)).map(product => <SelectItem key={product.id} value={product.id}>
              ...
              <div className="space-y-2">
                ...
                <Textarea id="description" name="description" placeholder="Describe the maintenance item (e.g., bin liners)..." />
              </div>

              <div className="space-y-2">
                <Label htmlFor="current_stock">Current Stock Level *</Label>
                <Input id="current_stock" name="current_stock" type="number" min="0" placeholder="Enter current stock quantity" required />
              </div>
      ...
      <Card>
        ...
        <CardContent>
          {dependencies.length === 0 ? <div className="text-center py-12">
              ...
              <TableBody>
                {dependencies.map(item => <TableRow key={item.id}>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-xl">
          ...
          {editingItem && <form onSubmit={handleEditMaintenance} className="space-y-4">
              <div className="space-y-2">
                <Label>Product</Label>
                <Input value={getProductName(editingItem.product_id)} disabled className="bg-muted" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="edit_description">Description</Label>
                <Textarea id="edit_description" name="description" defaultValue={editingItem.description || ''} placeholder="Describe the maintenance item (e.g., bin liners)..." />
              </div>

              <div className="space-y-2">
                <Label htmlFor="edit_current_stock">Current Stock Level *</Label>
                <Input id="edit_current_stock" name="current_stock" type="number" min="0" defaultValue={editingItem.current_stock || 0} required />
              </div>
