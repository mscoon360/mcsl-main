...
export default function Inventory() {
  ...
  const getLatestRestockDate = () => {
    const dates = supplies
      .map((s) => s.last_restock_date)
      .filter((d) => d !== null)
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Last Restock Date</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-2xl font-semibold">
            {getLatestRestockDate()
              ? new Date(getLatestRestockDate()!).toLocaleDateString()
              : "No restock records"}
          </p>
        </CardContent>
      </Card>
                  ...
                  supplies.map((supply) => (
                    <TableRow key={supply.id}>
                      ...
                      <TableCell>
                        <span
                          className={
                            supply.quantity <= supply.min_stock_level
                      ...
                      <TableCell>
                        {supply.last_restock_date
                          ? new Date(supply.last_restock_date).toLocaleDateString()
                          : "N/A"}
                      </TableCell>
                      <TableCell>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    min="0"
                    defaultValue={editingSupply.min_stock_level}
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="edit-last_restock_date">Last Restock Date</Label>
                  <Input
                    id="edit-last_restock_date"
                    name="last_restock_date"
                    type="date"
                    defaultValue={editingSupply.last_restock_date || ""}
                  />
                </div>
              </div>
              <div className="space-y-2">
